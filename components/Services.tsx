        ...
        <div className="bg-[#252525] rounded-[40px] 2xl:p-[100px] lg:p-[80px] p-[20px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 mt-[30px] md:mt-[90px] 2xl:gap-[130px] lg:gap-[50px] gap-[30px] justify-items-center">
                <div className="bg-[#673147] w-3/4 lg:w-full lg:h-[350px] py-[50px] px-[25px] flex flex-col rounded-[30px] text-center lg:gap-[50px] gap-[20px]">
                    ...
                    <p className="text-[#8C8C8C] text-[18px]">Manage communications between the DAO and its community members, moderate DAO's discussion forums (e.g., Twitter, Discord, Discourse, etc.), attend to inbound media inquiries.</p>
                </div>
                <div className="bg-[#673147] w-3/4 lg:w-full lg:h-[350px] py-[50px] px-[25px] flex flex-col rounded-[30px] text-center lg:gap-[50px] gap-[20px]">
                    <p className="font-bold text-[28px]">DAO Governance</p>
                    <p className="text-[#8C8C8C] text-[18px]">Manage, monitor and record the results of the governance process, voting and results, ecosystem grants program management services, and more.</p>
                </div>
                <div className="bg-[#673147] w-3/4 lg:w-full lg:h-[350px] py-[50px] px-[25px] flex flex-col rounded-[30px] text-center lg:gap-[50px] gap-[20px]">
                    <p className="font-bold text-[28px]">Treasury Management</p>
                    <p className="text-[#8C8C8C] text-[18px]">Design bespoke treasury monitoring dashboard for DAO communities,
consult Foundation Company directors on management of treasury capital and diversification of assets,
support multisig signers managed by third party custody providers, and more.</p>
                </div>
            </div>
        </div>
