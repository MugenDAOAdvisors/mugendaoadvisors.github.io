    ...
    return (
            <div className="bg-[#252525] rounded-t-[40px] 2xl:p-[100px] p-[20px] flex justify-between items-center">
                <div className="w-full md:w-1/2 lg:w-1/3 flex flex-col">                
                    ...
                    <p className="text-[#7E7E7E] mt-[15px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do.</p>
                    <div className="flex mt-[50px]">
                        <p className="text-black lg:px-[70px] lg:py-[20px] py-[10px] px-[20px] text-center bg-[#EE6FA3] rounded-full font-medium">Call Us Today</p>
                    </div>
                </div>
