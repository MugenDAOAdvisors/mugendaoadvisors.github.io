    ...
    return(
        <div className="flex flex-col">
            ...
            <div className="flex flex-col xl:flex-row mt-[15px]">
                <p className="xl:w-1/2">Mugen provides a full suite of solutions for projects who want to achieve maximum decentralization, transparency and scalability. It provides a professional service performing all functions required to run DAOs and its related entities.</p>
            </div>
